...
const caseStudies = [
  ...
  {
    slug: "developing-faith",
    title: "Developing Unshakeable Faith",
    category: "faith",
    format: "Article",
    audience: "Young Professional",
    description: "A practical guide to cultivating and deepening faith in God, even when facing doubts, difficulties, and modern skepticism.",
